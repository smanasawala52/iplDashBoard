...
public class Match implements Comparable<Match> {
	...
	/**
	 * @param eventMatchNumber the eventMatchNumber to set
	 */
	...
	public String toString() {
		return "Match [id=" + id + ", city=" + city + ", date=" + date + ", playerOfMatch=" + playerOfMatch + ", venue="
				...
				+ tossWinner + ", tossDecision=" + tossDecision + ", eventStage=" + eventStage + ", eventMatchNumber="
				+ eventMatchNumber + ", eventGroup=" + eventGroup + ", season=" + season + ", players=" + players + "]";
	}
