...
public class MatchInputJsonInfo {
	...
	public String toString() {
		return "MatchInputJsonInfo [ballsPerOver=" + ballsPerOver + ", bowlOut="
				+ bowlOut + ", city=" + city + ", dates=" + dates + ", event="
				+ event + ", gender=" + gender + ", matchType=" + matchType
				+ ", matchTypeNumber=" + matchTypeNumber + ", missing="
				+ missing + ", officials=" + officials + ", outcome=" + outcome
				+ ", overs=" + overs + ", playerOfMatch=" + playerOfMatch
				+ ", players=" + players + ", season=" + season + ", teamType="
				+ teamType + ", teams=" + teams + ", toss=" + toss + ", venue="
				+ venue + "]";
	}
}
