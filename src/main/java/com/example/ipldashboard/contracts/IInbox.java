...
public class IInbox extends Contract {
    ...
    public RemoteFunctionCall<TransactionReceipt> createRetryableTicket(String destAddr, BigInteger arbTxCallValue, BigInteger maxSubmissionCost, String submissionRefundAddress, String valueRefundAddress, BigInteger maxGas, BigInteger gasPriceBid, byte[] data) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_CREATERETRYABLETICKET, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(destAddr), 
                ...
                new org.web3j.abi.datatypes.Address(submissionRefundAddress), 
                new org.web3j.abi.datatypes.Address(valueRefundAddress), 
    ...
    public RemoteFunctionCall<TransactionReceipt> createRetryableTicketNoRefundAliasRewrite(String destAddr, BigInteger arbTxCallValue, BigInteger maxSubmissionCost, String submissionRefundAddress, String valueRefundAddress, BigInteger maxGas, BigInteger gasPriceBid, byte[] data) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
    ...
    public RemoteFunctionCall<TransactionReceipt> depositEth(BigInteger maxSubmissionCost) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_DEPOSITETH, 
    ...
    public RemoteFunctionCall<TransactionReceipt> sendContractTransaction(BigInteger maxGas, BigInteger gasPriceBid, String destAddr, BigInteger amount, byte[] data) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                ...
                new org.web3j.abi.datatypes.generated.Uint256(gasPriceBid), 
                new org.web3j.abi.datatypes.Address(destAddr), 
    ...
    public RemoteFunctionCall<TransactionReceipt> sendL1FundedContractTransaction(BigInteger maxGas, BigInteger gasPriceBid, String destAddr, byte[] data) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
    ...
    public RemoteFunctionCall<TransactionReceipt> sendL1FundedUnsignedTransaction(BigInteger maxGas, BigInteger gasPriceBid, BigInteger nonce, String destAddr, byte[] data) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
