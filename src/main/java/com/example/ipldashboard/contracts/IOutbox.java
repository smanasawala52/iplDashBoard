...
public class IOutbox extends Contract {
    ...
    public List<OutboxEntryCreatedEventResponse> getOutboxEntryCreatedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(OUTBOXENTRYCREATED_EVENT, transactionReceipt);
