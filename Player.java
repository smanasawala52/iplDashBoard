...
public class Player {
	...
	@Transient
	private Map<String,Player> matchesBreakDownBySeason = new HashMap<>();
	...
	/**
	 * @param doubleHundreds
	 *            the doubleHundreds to set
	 */
	 ...
	 */
	public void setMatchesBreakDownBySeason(
			Map<String, Player> matchesBreakDownBySeason) {
