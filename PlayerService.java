		...
		if (matches != null && !matches.isEmpty()) {
			...
			if (stream != null) {
				stream.forEach(playerInput -> {
					...
					Player playerInfoBySeasonTemp = playerTemp.getMatchesBreakDownBySeason().get(playerTemp.getSeason());
...
//					if(player!=null && !player.isEmpty()) {
						...
						System.out.println(playerInfoBySeasonTemp);
//					}
			...
			if (sortBy != null && !sortBy.isEmpty()) {
				if (sortBy.equalsIgnoreCase("name-a")) {
					...
					Collections.sort(playersLst, (o1, o2) -> {
						if (o1 != null && o2 != null && o1.getPlayerOfMatch() != null && o2.getPlayerOfMatch() != null) {
	...
	private void populatePlayersInfo(Player playerTemp, Player playerInput,
			Match match, int cp, int pageSize) {playerTemp.getTeamNames().add(playerInput.getTeam());
			// Batting avg
